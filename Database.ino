...
#define WIFI_SSID "Happyisb1"
#define WIFI_PASSWORD "24862573"

// For the following credentials, see examples/Authentications/SignInAsUser/EmailPassword/EmailPassword.ino

/* 2. Define the API Key */
#define API_KEY "AIzaSyC_emptWsXGQ5U4ZtlCg7F2C9d2Lwj25Y0"


/* 3. Define the RTDB URL */
#define DATABASE_URL "ensurevac-4efe4-default-rtdb.firebaseio.com" //<databaseName>.firebaseio.com or <databaseName>.<region>.firebasedatabase.app
